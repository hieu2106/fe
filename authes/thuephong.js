(async function () {
  function onAddPhong() {
    ...
    addRow(makh, maphong, ngayden, ngaydi);
  ...
  function addRow(makh, maphong, ngayden, ngaydi) {
    ...
    cell2.innerHTML = makh;
    cell3.innerHTML = maphong;
    cell4.innerHTML = ngayden;
    cell5.innerHTML = ngaydi;
    cell6.innerHTML = `<button class="btn btn-danger" data-id="${maphong}">Xóa</button>`;
  }
  ...
  reloadSelect(khachHangs, document.querySelector("[name=makh]"), "makh", "makh");
